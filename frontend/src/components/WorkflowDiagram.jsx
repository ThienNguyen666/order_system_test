...
const NODES = [
  ...
  { id: 'authorize_payment_ref', altIds: ['authorize_payment_recovery_ref'], label: 'Authorize Payment', shape: 'rect', x: 790, y: 155, w: 160, h: 50 },
  ...
  { id: 'manual_approval_ref', altIds: ['payment_recovery_ref'], label: 'Human Review', shape: 'rect', x: 1340, y: 120, w: 160, h: 50 },
  { id: 'approval_decision_ref', label: 'Approval Decision', shape: 'diamond', x: 1545, y: 145, w: 125, h: 70 },
  { id: 'shipment_ref', altIds: ['create_shipment_ref', 'shipment_recovery_ref'], label: 'Shipment Sub-Workflow', sublabel: 'create_shipment', shape: 'rect', x: 1730, y: 45, w: 180, h: 50 },
  { id: 'update_status_success_ref', altIds: ['update_status_recovery_success_ref'], label: 'Update Status', sublabel: 'COMPLETED', shape: 'rect', x: 1945, y: 45, w: 170, h: 50 },
  { id: 'release_inventory_comp_ref', altIds: ['release_inventory_reject_ref', 'release_inventory_recovery_ref', 'release_inventory_recovery_declined_ref'], label: 'Release Inventory', shape: 'rect', x: 1190, y: 265, w: 160, h: 50 },
  { id: 'void_payment_comp_ref', altIds: ['void_payment_reject_ref', 'void_payment_recovery_ref'], label: 'Void Payment', shape: 'rect', x: 1380, y: 265, w: 150, h: 50 },
  { id: 'update_status_comp_ref', altIds: ['update_status_reject_ref', 'update_status_startup_reject_ref', 'update_status_recovery_comp_ref', 'update_status_recovery_declined_ref'], label: 'Update Status', sublabel: 'COMPENSATED/FAILED', shape: 'rect', x: 1565, y: 265, w: 180, h: 50 },
]
const EDGES = [
